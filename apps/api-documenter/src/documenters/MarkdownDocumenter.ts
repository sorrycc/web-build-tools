...
export class MarkdownDocumenter {
  ...
  private readonly _pluginContext: PluginContext;
  private readonly _tsdocConfiguration: TSDocConfiguration;
  private readonly _markdownEmitter: CustomMarkdownEmitter;
  private _outputFolder: string;

  public constructor(apiModel: ApiModel, pluginContext: PluginContext) {
  ...
  private _writeApiItemPage(apiItem: ApiItem): void {
    ...
    if (this._pluginContext.markdownDocumenterFeature) {
      ...
      this._pluginContext.markdownDocumenterFeature.onBeforeWritePage(eventArgs);
